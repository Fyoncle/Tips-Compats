...
## This resourcepack adds mod compatibility to the [Tips](https://modrinth.com/mod/tips) mod!
...
- [Armorable Skeleton Horses](https://modrinth.com/mod/armorable-skeleton-horses)
- [Balanced Horse Armor Recipes](https://modrinth.com/mod/bhar) *(Won't work with the datapack version)*
- [Horseman](https://modrinth.com/mod/horseman)
- [Two Players One Horse](https://modrinth.com/mod/two-players-one-horse)
- [Floating Horses](https://modrinth.com/mod/floating-horses)
- [Calm down, dog!](https://modrinth.com/mod/calm-down-dog)
...
- [RME's Campfire Leather](https://modrinth.com/mod/rmes-campfire-leather) *(Won't work with the datapack version)*
- [Simple Concrete](https://modrinth.com/mod/simple-concrete)
